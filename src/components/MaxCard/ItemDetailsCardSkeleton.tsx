  ...
  return (
    <div className={`rounded-2xl shadow-xl border overflow-hidden animate-pulse transition-colors duration-300 ${
      theme === 'dark'
        ...
        // ✅ التعديل هنا: استخدام نفس خلفية البطاقة الفعلية
        : 'bg-white border-gray-200' 
    }`}>
      <div className="grid grid-cols-1 md:grid-cols-5">
        {/* Image Skeleton */}
        {/* ✅ التعديل هنا: استخدام درجة أفتح من الرمادي */}
        ...
        <div className="md:col-span-3 p-8 space-y-6">
          ...
          <div className={`grid grid-cols-2 gap-x-6 gap-y-4 pt-6 border-t ${
            ...
            {/* ✅ التعديل هنا: استخدام درجة أفتح من الرمادي */}
            <div className={`h-6 rounded w-full ${theme === 'dark' ? 'bg-gray-700' : 'bg-gray-200'}`}></div>
            <div className={`h-6 rounded w-full ${theme === 'dark' ? 'bg-gray-700' : 'bg-gray-200'}`}></div>
            <div className={`h-6 rounded w-5/6 ${theme === 'dark' ? 'bg-gray-700' : 'bg-gray-200'}`}></div>
            <div className={`h-6 rounded w-4/6 ${theme === 'dark' ? 'bg-gray-700' : 'bg-gray-200'}`}></div>
          </div>
          ...
          {/* Button Skeleton */}
          <div className="pt-8">
            {/* ✅ التعديل هنا: استخدام درجة أفتح من البرتقالي */}
            <div className={`h-14 rounded-full w-full ${
              theme === 'dark' ? 'bg-orange-800/50' : 'bg-orange-100' // تم التغيير من orange-200
            }`}></div>
          </div>
        </div>
      </div>

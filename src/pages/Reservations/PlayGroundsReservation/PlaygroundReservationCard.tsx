...
import { FaFutbol, FaCalendarAlt, FaClock, FaDollarSign } from 'react-icons/fa';
import InfoRow from '../../../components/Reservation/infoRow';
import StatusBadge from '../../../components/Reservation/StatusBadge';
import type { PlayGroundReservation } from '../../../types';
  ...
  return (
    <div className="bg-gray-800/50 border border-gray-700 rounded-lg p-5 transition-all hover:border-orange-500/50 hover:shadow-xl">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 border-t border-gray-700 pt-4">
        <InfoRow icon={<FaCalendarAlt />} label="التاريخ" value={reservation.reservation_date} />
        <InfoRow icon={<FaClock />} label="الوقت" value={reservation.reservation_time} />
        <InfoRow icon={<FaDollarSign />} label="السعر" value={`${reservation.final_price || reservation.price}$`} />
      </div>
